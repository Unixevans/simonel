...
$wkt_awl = '06:00:00';
$wkt_akr = '18:00:00';
$tanggal = mysqli_query($connect, "SELECT created_at FROM pzem_data WHERE DATE_FORMAT(created_at, '%H:%s:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
// .......
$now = new DateTime();
...
if (!isset($_POST['submit'])) {
    ...
    $data = array();
    for ($i=6; $i<=18; $i+=1) {
        $dayareaktifA = mysqli_query($connect, "SELECT AVG(dayareaktifA) as avg_dayareaktif FROM pzem_data WHERE DATE(created_at) = '$tgl_real' AND TIME(created_at) BETWEEN ADDTIME('$i:00:00', '-1:00:00') AND '$i:00:00'");
        $data_dayareaktifA = mysqli_fetch_array($dayareaktifA);
        $data[] = round($data_dayareaktifA['avg_dayareaktif'], 1);
    }
    ...
    $dayareaktifA = mysqli_query($connect, "SELECT dayareaktifA FROM pzem_data WHERE DATE(created_at) = '$tgl_real' AND DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
    // -----------------------------------------------------------------------------------
    // Higher Voltage
    $result1 = mysqli_query($connect, "SELECT MAX(dayareaktifA) as max_teg FROM pzem_data WHERE DATE(created_at) = '$tgl_real'");
    $higher = mysqli_fetch_array($result1);
    $max_teg = $higher['max_teg'];
    $max_teg_formatted = number_format($max_teg, 1);

    // Average Voltage
    $result2 = mysqli_query($connect, "SELECT AVG(dayareaktifA) as avg_teg FROM pzem_data WHERE DATE(created_at) = '$tgl_real'");
    ...
    $query_data = mysqli_query($connect, "SELECT dayareaktifA FROM pzem_data WHERE DATE(created_at) = '$tgl_real' AND DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
    ...
    $data = array();
    for ($i=6; $i<=18; $i+=1) {
        $dayareaktifA = mysqli_query($connect, "SELECT AVG(dayareaktifA) as avg_dayareaktif FROM pzem_data WHERE DATE(created_at) = '$tgl_awal' AND TIME(created_at) BETWEEN ADDTIME('$i:00:00', '-1:00:00') AND '$i:00:00'");
        $data_dayareaktifA = mysqli_fetch_array($dayareaktifA);
        $data[] = round($data_dayareaktifA['avg_dayareaktif'], 1);
    }
    ...
    // CONDITION
    $dayareaktifA = mysqli_query($connect, "SELECT dayareaktifA FROM pzem_data WHERE DATE(created_at) = '$tgl_awal' AND DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
    // -----------------------------------------------------------------------------------
    // Higher Voltage
    $result1 = mysqli_query($connect, "SELECT MAX(dayareaktifA) as max_teg FROM pzem_data WHERE DATE(created_at) = '$tgl_awal'");
    $higher = mysqli_fetch_array($result1);
    $max_teg = $higher['max_teg'];
    $max_teg_formatted = number_format($max_teg, 1);

    // Average Voltage
    $result2 = mysqli_query($connect, "SELECT AVG(dayareaktifA) as avg_teg FROM pzem_data WHERE DATE(created_at) = '$tgl_awal'");
    $avg = mysqli_fetch_array($result2);
    $avg_teg = $avg["avg_teg"];
    $avg_teg_formatted = number_format($avg_teg, 1);
    // ---------
    ...
    // syntax for the scroll
    $query_data = mysqli_query($connect, "SELECT dayareaktifA FROM pzem_data WHERE DATE(created_at) = '$tgl_awal' AND DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
                ...
                <ul class="navigation">
                    ...
                    <li>
                        ...
                        <ul class="dropdown1">
                            ...
                            <li><a href="microA-VAR.php" id="active"><i class="fa-regular fa-v"></i><i class="fa-regular fa-a"></i><i class="fa-regular fa-r"></i>
                    ...
                    <div class="grafikP">
                        <div class="grafik">
                            ...
                            <div style="text-align: center;height: 30px; align-items:center; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                                STATISTIK RATA-RATA PERJAM DAYA REAKTIF MICROINVENTER A
                            </div>
