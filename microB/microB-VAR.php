...
$wkt_akr = '18:00:00';
// ----------
$tanggal = mysqli_query($connect, "SELECT created_at FROM pzem_data WHERE DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
// ........
$now = new DateTime();
...
if (!isset($_POST['submit'])) {
    ...
    $data = array();
    for ($i=6; $i<=18; $i+=1) {
        $dayareaktifB = mysqli_query($connect, "SELECT AVG(dayareaktifB) as avg_dayareaktif FROM pzem_data WHERE DATE(created_at) = '$tgl_real' AND TIME(created_at) BETWEEN ADDTIME('$i:00:00', '-1:00:00') AND '$i:00:00'");
        $data_dayareaktifB = mysqli_fetch_array($dayareaktifB);
        $data[] = round($data_dayareaktifB['avg_dayareaktif'], 1);
    }
    ...
    $data_v = array(
        ...
        'datasets' => array(
            array(
                'label' => 'Voltage',
                'fill' => true,
                'backgroundColor' => "rgba(169, 181, 212, .7)",
                'borderColor' => "rgba(169, 181, 212, 2)",
                'data' => $data
            )
        )
    );  

    $dayareaktifB = mysqli_query($connect, "SELECT dayareaktifB FROM pzem_data WHERE DATE(created_at) = '$tgl_real' AND DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
    // -----------------------------------------------------------------------------------
    // Higher Voltage
    $result1 = mysqli_query($connect, "SELECT MAX(dayareaktifB) as max_teg FROM pzem_data WHERE DATE(created_at) = '$tgl_real'");
    ...
    // Average Voltage
    $result2 = mysqli_query($connect, "SELECT AVG(dayareaktifB) as avg_teg FROM pzem_data WHERE DATE(created_at) = '$tgl_real'");
    ...
    $query_data = mysqli_query($connect, "SELECT dayareaktifB FROM pzem_data WHERE DATE(created_at) = '$tgl_real' AND DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
    ...
    $data = array();
    for ($i=6; $i<=18; $i+=1) {
        $dayareaktifB = mysqli_query($connect, "SELECT AVG(dayareaktifB) as avg_dayareaktif FROM pzem_data WHERE DATE(created_at) = '$tgl_awal' AND TIME(created_at) BETWEEN ADDTIME('$i:00:00', '-1:00:00') AND '$i:00:00'");
        $data_dayareaktifB = mysqli_fetch_array($dayareaktifB);
        $data[] = round($data_dayareaktifB['avg_dayareaktif'], 1);
    }
    ...
    // CONDITION
    $dayareaktifB = mysqli_query($connect, "SELECT dayareaktifB FROM pzem_data WHERE DATE(created_at) = '$tgl_awal' AND DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
    // -----------------------------------------------------------------------------------
    // Higher Voltage
    $result1 = mysqli_query($connect, "SELECT MAX(dayareaktifB) as max_teg FROM pzem_data WHERE DATE(created_at) = '$tgl_awal'");
    $higher = mysqli_fetch_array($result1);
    $max_teg = $higher['max_teg'];
    $max_teg_formatted = number_format($max_teg, 1);
    ...
    // Average Voltage
    $result2 = mysqli_query($connect, "SELECT AVG(dayareaktifB) as avg_teg FROM pzem_data WHERE DATE(created_at) = '$tgl_awal'");
    $avg = mysqli_fetch_array($result2);
    $avg_teg = $avg["avg_teg"];
    $avg_teg_formatted = number_format($avg_teg, 1);
    // ---------
    ...
    // syntax for the scroll
    $query_data = mysqli_query($connect, "SELECT dayareaktifB FROM pzem_data WHERE DATE(created_at) = '$tgl_awal' AND DATE_FORMAT(created_at, '%H:%i:%s') BETWEEN '$wkt_awl' AND '$wkt_akr' AND HOUR(created_at) % 2 = 0 ORDER BY ID ASC");
...
<head>
    ...
    <title>Daya Reaktif - MONEL</title>
    <!-- Shortcut icon -->
                    ...
                    <li>
                        ...
                        <ul class="dropdown2">
                            <li><a href="microB-V.php"><i class="fa-regular fa-v"></i>
                                    <label class="text-dp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tegangan</label></a></li>
                            <li><a href="microB-A.php"><i class="fa-regular fa-a"></i>
                                    <label class="text-dp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Arus</label></a></li>
                            ...
                            <li><a href="microB-W.php"><i class="fa-regular fa-w"></i>
                                    <label class="text-dp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Daya Nyata</label></a></li>
                            <li><a href="microB-VAR.php" id="active"><i class="fa-regular fa-v"></i><i class="fa-regular fa-a"></i><i class="fa-regular fa-r"></i>
                                    <label class="text-dp">&nbsp;&nbsp;Daya Reaktif</label></a></li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <div class="grafikP">
                        <div class="grafik">
                            ...
                            <div style="text-align: center;height: 30px; align-items:center; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                                STATISTIK DAYA REAKTIF MICROINVENTER B
                            </div>
